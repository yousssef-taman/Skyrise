...
//                UserCredentials userCredentials = addAccount(1, "example@gmail.com", "securepassword", Role.USER);
//
//                // Create User
//                FlightLeg.User user = addUser(1, userCredentials, Gender.FEMALE, "Jane", "Doe", "123456789",
...
//        }
//
//        private UserCredentials addAccount(Integer accountId, String email, String password, Role role) {
...
//        }
//
//        private FlightLeg.User addUser(Integer userId, UserCredentials userCredentials, Gender gender, String firstName, String lastName,
//                                       String nationalId,
...
//        }
//
//        private Reservation addReservation(FlightLeg.User user, Flight flight, SeatClass seatClass, int reservedSeats) {
...
//
//                FlightLeg.User managedUser = userRepository.findById(user.getUserId()).orElseThrow(
